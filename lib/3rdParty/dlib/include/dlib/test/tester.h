...
void check_test(bool _exp, long line, const char *file, const char *_exp_str);
...
public:
  tester(const std::string &switch_name, const std::string &description_,
  ...
  const std::string &cmd_line_switch() const;
  /*!
      ensures
  ...
  unsigned long num_of_args() const;
  /*!
      ensures
  ...
  virtual void perform_test(const std::string &arg);
  /*!
      requires
  ...
  virtual void perform_test(const std::string &arg1, const std::string &arg2);
  /*!
      requires
