...
!*/
{
  ...
  for (int j = 0; j < 3; ++j) {
    ...
    for (int k = 0; k < 5; ++k) {
      ...
      DLIB_TEST_MSG(test.option(_dT(ct, "c")).count() == 1,
                    test.option(_dT(ct, "c")).count());
    ...
    for (int k = 0; k < 5; ++k) {
      ...
      DLIB_TEST_MSG(
          test2.option(_dT(ct, "Z")).argument(0, 0) == _dT(ct, "zarg"),
          narrow(_dT(ct, "*") + test2.option(_dT(ct, "Z")).argument(0, 0) +
                 _dT(ct, "*")));
    }
    ...
    for (int k = 0; k < 5; ++k) {
      ...
      DLIB_TEST(test.option(_dT(ct, "Z")).argument(0, 0) == _dT(ct, "zarg"));
      DLIB_TEST(test.option(_dT(ct, "Z")).argument(1, 0) == _dT(ct, "asdf"));
      DLIB_TEST(test.option(_dT(ct, "davis")).argument(0, 0) ==
                _dT(ct, "darg"));
      DLIB_TEST_MSG(test.option(_dT(ct, "davis")).argument(1, 0) ==
                        _dT(ct, "darg2"),
    ...
    for (int k = 0; k < 5; ++k) {
      ...
      DLIB_TEST(test.option(_dT(ct, "Z")).argument(0, 0) == _dT(ct, "zarg"));
      DLIB_TEST(test.option(_dT(ct, "Z")).argument(1, 0) == _dT(ct, "asdf"));
      DLIB_TEST(test.option(_dT(ct, "dav-is")).argument(0, 0) ==
                _dT(ct, "darg"));
      DLIB_TEST_MSG(test.option(_dT(ct, "dav-is")).argument(1, 0) ==
                        _dT(ct, "darg2"),
    ...
    DLIB_TEST(test.option(_dT(ct, "davis")).description() ==
              _dT(ct, "davis option"));
    ...
    DLIB_TEST(test.option(_dT(ct, "mavis")).description() ==
              _dT(ct, "mavis option"));
    DLIB_TEST(test.option(_dT(ct, "b")).description() == _dT(ct, "b option"));
    DLIB_TEST(test.option(_dT(ct, "d")).description() == _dT(ct, "d option"));
    DLIB_TEST(test.option(_dT(ct, "Z")).description() == _dT(ct, "Z option"));
    ...
    for (int k = 0; k < 5; ++k) {
      ...
      DLIB_TEST_MSG(test.number_of_arguments() == 4,
                    test.number_of_arguments());
      DLIB_TEST(test[0] == _dT(ct, "arg1"));
      DLIB_TEST(test[1] == _dT(ct, "arg2"));
