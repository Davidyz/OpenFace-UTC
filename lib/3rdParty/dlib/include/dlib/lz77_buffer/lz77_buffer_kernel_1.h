...
template <typename sliding_buffer> class lz77_buffer_kernel_1 {
  /*!
      REQUIREMENTS ON sliding_buffer
          sliding_buffer must be an implementation of
  sliding_buffer/sliding_buffer_kernel_abstract.h
...
public:
  lz77_buffer_kernel_1(unsigned long total_limit_,
...
private:
  inline void shift_buffer(unsigned long N)
  /*!
      requires
          - N <= lookahead_size
      ensuers
  ...
  lz77_buffer_kernel_1(
      lz77_buffer_kernel_1<sliding_buffer> &); // copy constructor
  lz77_buffer_kernel_1<sliding_buffer> &
  operator=(lz77_buffer_kernel_1<sliding_buffer> &); // assignment operator
};
...
template <typename sliding_buffer>
void lz77_buffer_kernel_1<sliding_buffer>::clear() {
  lookahead_size = 0;
  history_size = 0;
}
...
template <typename sliding_buffer>
void lz77_buffer_kernel_1<sliding_buffer>::add(unsigned char symbol) {
...
template <typename sliding_buffer>
void lz77_buffer_kernel_1<sliding_buffer>::find_match(
