...
template <typename domain, typename range, typename bst_base,
...
class hash_table_kernel_2 : public enumerable<map_pair<domain, range>>,
  ...
  /*!
      ...
      CONVENTION
          ...
          the elements in this hash table are stored in the bst_base objects in
  the array table
...
public:
  ...
  explicit hash_table_kernel_2(unsigned long expnum);

  virtual ~hash_table_kernel_2() { pool.deallocate_array(table); }
  ...
  const range *operator[](const domain &item) const;

  range *operator[](const domain &item);

  inline void swap(hash_table_kernel_2 &item);
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
inline void
swap(hash_table_kernel_2<domain, range, bst_base, mem_manager, compare> &a,
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
hash_table_kernel_2<domain, range, bst_base, mem_manager,
                    compare>::hash_table_kernel_2(unsigned long expnum)
    : hash_size(0), current_bucket(0), at_start_(true) {
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager,
                         compare>::clear() {
  if (hash_size != 0) {
    hash_size = 0;
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
size_t
hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::size()
    const {
  return hash_size;
}
// ----------------------------------------------------------------------------------------
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
unsigned long
hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::count(
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager,
                         compare>::destroy(const domain &item) {
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::add(
    domain &d, range &r) {
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::remove(
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
const range *
hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::operator[](
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::swap(
    hash_table_kernel_2<domain, range, bst_base, mem_manager, compare> &item) {
  pool.swap(item.pool);
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
bool hash_table_kernel_2<domain, range, bst_base, mem_manager,
...
template <typename domain, typename range, typename bst_base,
          typename mem_manager, typename compare>
void hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::reset()
    const {
  at_start_ = true;
  if (current_bucket != 0) {
...
hash_table_kernel_2<domain, range, bst_base, mem_manager, compare>::element()
    const {
