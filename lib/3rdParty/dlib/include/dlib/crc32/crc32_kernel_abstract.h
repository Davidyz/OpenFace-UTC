...
public:
  ...
  /*!
      ensures
          - #get_checksum() == The checksum of all items added to *this
  previously concatenated with item.
  !*/
  ...
  unsigned long get_checksum() const;
  /*!
      ensures
...
void swap(crc32 &a, crc32 &b) { a.swap(b); }
/*!
