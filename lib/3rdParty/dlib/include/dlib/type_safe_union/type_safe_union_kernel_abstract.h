...
template <typename T1,
          ...
          typename T3 = _void, typename T4 = _void, typename T5 = _void,
          typename T6 = _void, typename T7 = _void, typename T8 = _void,
          typename T9 = _void, typename T10 = _void, typename T11 = _void,
          typename T12 = _void, typename T13 = _void, typename T14 = _void,
          typename T15 = _void, typename T16 = _void, typename T17 = _void,
          typename T18 = _void, typename T19 = _void, typename T20 = _void>
...
public:
  ...
  template <typename T> type_safe_union(const T &item);
  /*!
      requires
  ...
  /*!
      ensures
          - if (this type_safe_union currently contains an object of type T)
  then
              - returns true
          - else
              - returns false
  ...
  /*!
      requires
          - obj is a function object capable of operating on all the types
  contained in this type_safe_union.  I.e.  obj(this->get<U>()) must be a valid
            expression for all the possible U types.
      ensures
          - if (is_empty() == false) then
              - Let U denote the type of object currently contained in this
  type_safe_union
  ...
  type_safe_union.
          - else
              ...
              - Any previous object stored in this type_safe_union is destructed
  ...
  /*!
      ...
      ensures
          - if (contains<T>() == true) then
              - returns a const reference to the object contained in this
  type_safe_union.
          - else
...
template <...>
inline void swap(type_safe_union<...> &a, type_safe_union<...> &b) {
  a.swap(b);
}
/*!
...
template <...>
void serialize(const type_safe_union<...> &item, std::ostream &out);
/*!
...
template <...> void deserialize(type_safe_union<...> &item, std::istream &in);
/*!
