...
/*!
    ensures
        - Attempts to load the MNIST dataset from the hard drive.  This is the
dataset of handwritten digits available from http://yann.lecun.com/exdb/mnist/.
In particular, the 4 files comprising the MNIST dataset should be present in the
    ...
    throws
        - dlib::error if some problem prevents us from loading the data or the
