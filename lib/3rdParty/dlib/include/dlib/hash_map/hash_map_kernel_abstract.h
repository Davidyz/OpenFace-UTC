...
class hash_map : public enumerable<map_pair<domain, range>>,
  ...
  compatible with std::less and domain must be hashable by general_hash
...
inline void swap(hash_map<domain, range, expnum, mem_manager, compare> &a,
...
template <typename domain, typename range, unsigned long expnum,
          typename mem_manager, typename compare>
void deserialize(hash_map<domain, range, expnum, mem_manager, compare> &item,
                 std::istream &in);
/*!
