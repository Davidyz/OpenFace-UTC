...
template <typename hash_map_base>
...
template <typename hash_map_base>
inline void swap(hash_map_kernel_c<hash_map_base> &a,
...
template <typename hash_map_base>
void hash_map_kernel_c<hash_map_base>::add(domain &d, range &r) {

  // make sure requires clause is not broken
  DLIB_CASSERT((!this->is_in_domain(d)) &&
                   (static_cast<void *>(&d) != static_cast<void *>(&r)),
               "\tvoid hash_map::add"
                   << "\n\tdomain element being added must not already be in "
                      "the hash_map"
                   << "\n\tand d and r must not be the same variable"
                   << "\n\tis_in_domain(d): "
                   << (this->is_in_domain(d) ? "true" : "false") << "\n\tthis: "
...
template <typename hash_map_base>
void hash_map_kernel_c<hash_map_base>::remove_any(domain &d, range &r) {

  // make sure requires clause is not broken
  DLIB_CASSERT((this->size() > 0) &&
                   (static_cast<void *>(&d) != static_cast<void *>(&r)),
               "\tvoid hash_map::remove_any"
                   << "\n\tsize() must be greater than zero if something is "
                      "going to be removed"
                   << "\n\tand d and r must not be the same variable."
                   << "\n\tsize(): " << this->size() << "\n\tthis:   " << this
                   << "\n\t&d:     " << static_cast<void *>(&d)
...
template <typename hash_map_base>
void hash_map_kernel_c<hash_map_base>::remove(const domain &d, domain &d_copy,
                                              range &r) {
  ...
  DLIB_CASSERT(
      ...
      "\tvoid hash_map::remove"
          << "\n\tcan't remove something that isn't in the hash_map or if the "
             "paremeters"
...
template <typename hash_map_base>
void hash_map_kernel_c<hash_map_base>::destroy(const domain &d) {
...
template <typename hash_map_base>
typename hash_map_base::range_type &
hash_map_kernel_c<hash_map_base>::operator[](const domain &d) {
  // make sure requires clause is not broken
  DLIB_CASSERT(this->is_in_domain(d),
...
template <typename hash_map_base>
const typename hash_map_base::range_type &
hash_map_kernel_c<hash_map_base>::operator[](const domain &d) const {
  // make sure requires clause is not broken
  DLIB_CASSERT(this->is_in_domain(d),
...
template <typename hash_map_base>
const map_pair<typename hash_map_base::domain_type,
               typename hash_map_base::range_type> &
hash_map_kernel_c<hash_map_base>::element() const {
  // make sure requires clause is not broken
  DLIB_CASSERT(
...
template <typename hash_map_base>
map_pair<typename hash_map_base::domain_type,
         typename hash_map_base::range_type> &
hash_map_kernel_c<hash_map_base>::element() {
  // make sure requires clause is not broken
  DLIB_CASSERT(
      this->current_element_valid() == true,
