...
unsigned long set_intersection_size(const T &a, const U &b);
/*!
    requires
...
void set_union(const T &a, const U &b, V &u);
/*!
    requires
...
template <typename T, typename U, typename V>
void set_intersection(const T &a, const U &b, V &i);
/*!
    requires
        - T, U, and V must all be implementations of set/set_kernel_abstract.h
        - the types of objects contained in these sets must be copyable
...
template <typename T, typename U, typename V>
void set_difference(const T &a, const U &b, V &d);
/*!
    requires
        - T, U, and V must all be implementations of set/set_kernel_abstract.h
        - the types of objects contained in these sets must be copyable
