...
inline const typename disable_if<is_same_type<charT, char>, std::string>::type
narrow(const std::basic_string<charT, traits, alloc> &str) {
  std::string temp;
...
template <typename charT, typename traits, typename alloc>
inline const typename enable_if<is_same_type<charT, char>, std::string>::type
narrow(const std::basic_string<charT, traits, alloc> &str) {
  return str;
}
...
tolower(const std::basic_string<char, traits, alloc> &str) {
  std::basic_string<char, traits, alloc> temp;

  temp.resize(str.size());

  for (typename std::basic_string<char, traits, alloc>::size_type i = 0;
       i < str.size(); ++i)
...
template <typename traits, typename alloc>
const std::basic_string<char, traits, alloc>
toupper(const std::basic_string<char, traits, alloc> &str) {
  std::basic_string<char, traits, alloc> temp;
...
template <typename traits, typename alloc>
bool strings_equal_ignore_case(
    const std::basic_string<char, traits, alloc> &str1, const char *str2) {
...
template <typename traits, typename alloc>
bool strings_equal_ignore_case(
    const char *str1, const std::basic_string<char, traits, alloc> &str2) {
...
bool strings_equal_ignore_case(
    const std::basic_string<char, traits, alloc> &str1,
    const std::basic_string<char, traits, alloc> &str2, unsigned long num) {
...
template <typename T> const std::string cast_to_string(const T &item) {
...
template <typename T> const std::wstring cast_to_wstring(const T &item) {
...
inline std::string pad_int_with_zeros(int i, unsigned long width = 6) {
  std::ostringstream sout;
...
public:
  string_cast_error(const std::string &str)
      : error(ESTRING_CAST,
              "string cast error: invalid string = '" + str + "'") {}
};

template <typename T> struct string_cast_helper {
  template <typename charT, typename traits, typename alloc>
  static const T cast(const std::basic_string<charT, traits, alloc> &str) {
    using namespace std;
    ...
    if (sin.get() != std::char_traits<charT>::eof())
      throw string_cast_error(narrow(str));
    return temp;
  }
};
...
struct string_cast_helper<std::basic_string<C, T, A>> {
  template <typename charT, typename traits, typename alloc>
  static const std::basic_string<C, T, A>
  cast(const std::basic_string<charT, traits, alloc> &str) {
...
template <> struct string_cast_helper<bool> {
  template <typename charT, typename traits, typename alloc>
  static bool cast(const std::basic_string<charT, traits, alloc> &str) {
    using namespace std;
...
#define DLIB_STRING_CAST_INTEGRAL(type)                                        \
  template <> struct string_cast_helper<type> {                                \
    template <typename charT, typename traits, typename alloc>                 \
    static type cast(const std::basic_string<charT, traits, alloc> &str) {     \
      using namespace std;                                                     \
      basic_istringstream<charT, traits, alloc> sin(str);                      \
      type temp;                                                               \
      if (str.size() > 2 && str[0] == _dT(charT, '0') &&                       \
          str[1] == _dT(charT, 'x'))                                           \
        sin >> hex >> temp;                                                    \
      else                                                                     \
        sin >> temp;                                                           \
...
inline const T string_cast(const std::basic_string<charT, traits, alloc> &str) {
  COMPILE_TIME_ASSERT(is_pointer_type<T>::value == false);
  return string_cast_helper<T>::cast(str);
}

template <typename T> inline const T string_cast(const char *str) {
  return string_cast<T>(std::string(str));
}
template <typename T> inline const T string_cast(const wchar_t *str) {
  return string_cast<T>(std::wstring(str));
}
...
class string_assign {
  ...
  public:
    string_assign_helper(const std::basic_string<charT, traits, alloc> &str_)
        : str(str_) {}

    template <typename T> operator T() const { return string_cast<T>(str); }
  ...
  public:
    char_assign_helper(const char *str_) : str(str_) {}
  ...
  public:
    wchar_t_assign_helper(const wchar_t *str_) : str(str_) {}
...
public:
  template <typename charT, typename traits, typename alloc>
  string_assign_helper<charT, traits, alloc>
  operator=(const std::basic_string<charT, traits, alloc> &str) const {
    return string_assign_helper<charT, traits, alloc>(str);
  }

  char_assign_helper operator=(const char *str) const {
    return char_assign_helper(str);
  }

  wchar_t_assign_helper operator=(const wchar_t *str) const {
...
wrap_string(const std::basic_string<charT, traits, alloc> &str,
            const unsigned long first_pad = 0, const unsigned long rest_pad = 0,
  ...
  typename basic_string<charT, traits, alloc>::size_type remaining =
      max_per_line - rest_pad;
...
wrap_string(const charT *str, const unsigned long first_pad = 0,
            const unsigned long rest_pad = 0,
            const unsigned long max_per_line = 79) {
  return wrap_string(std::basic_string<charT>(str), first_pad, rest_pad,
                     max_per_line);
}
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
ltrim(const std::basic_string<charT, traits, alloc> &str,
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
rtrim(const std::basic_string<charT, traits, alloc> &str,
      const std::basic_string<charT, traits, alloc> &trim_chars) {
  typedef std::basic_string<charT, traits, alloc> string;
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
trim(const std::basic_string<charT, traits, alloc> &str,
     const std::basic_string<charT, traits, alloc> &trim_chars) {
  typedef std::basic_string<charT, traits, alloc> string;
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
rpad(const std::basic_string<charT, traits, alloc> &str, long pad_length,
...
rpad(const std::basic_string<charT, traits, alloc> &str, long pad_length,
  ...
  return rpad(str, pad_length,
              std::basic_string<charT, traits, alloc>(pad_string));
}
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
lpad(const std::basic_string<charT, traits, alloc> &str, long pad_length,
     const std::basic_string<charT, traits, alloc> &pad_string) {
  typedef std::basic_string<charT, traits, alloc> string;
  // if str is too big then just return str
  if (pad_length <= static_cast<long>(str.size()))
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
left_substr(const std::basic_string<charT, traits, alloc> &str,
...
template <typename charT, typename traits, typename alloc>
const std::basic_string<charT, traits, alloc>
right_substr(const std::basic_string<charT, traits, alloc> &str,
             const std::basic_string<charT, traits, alloc> &delim) {
  typename std::basic_string<charT, traits, alloc>::size_type delim_pos =
      str.find_last_of(delim);
...
split_on_first(const std::basic_string<charT, traits, alloc> &str,
               const charT *delim = _dT(charT, " \n\r\t")) {
  typename std::basic_string<charT, traits, alloc>::size_type delim_pos =
...
template <typename charT, typename traits, typename alloc>
inline std::pair<std::basic_string<charT, traits, alloc>,
                 std::basic_string<charT, traits, alloc>>
split_on_first(const std::basic_string<charT, traits, alloc> &str,
               const std::basic_string<charT, traits, alloc> &delim) {
...
std::pair<std::basic_string<charT, traits, alloc>,
          std::basic_string<charT, traits, alloc>>
split_on_last(const std::basic_string<charT, traits, alloc> &str,
              const charT *delim = _dT(charT, " \n\r\t")) {
  typename std::basic_string<charT, traits, alloc>::size_type delim_pos =
      str.find_last_of(delim);
  if (delim_pos != std::basic_string<charT, traits, alloc>::npos)
...
template <typename charT, typename traits, typename alloc>
const std::vector<std::basic_string<charT, traits, alloc>>
...
inline const std::vector<std::string> split(const char *str,
                                            const char *delim = " \n\r\t") {
