...
template <unsigned long alphabet_size> class conditioning_class_kernel_2 {
  /*!
      INITIAL VALUE
          total == 1
...
public:
  ...
  conditioning_class_kernel_2(global_state_type &global_state_);
...
conditioning_class_kernel_2<alphabet_size>::conditioning_class_kernel_2(
    ...
    : total(1), symbols(new data[alphabet_size]), global_state(global_state_) {
  ...
  global_state.memory_usage +=
      sizeof(data) * alphabet_size + sizeof(conditioning_class_kernel_2);
}
...
template <unsigned long alphabet_size>
void conditioning_class_kernel_2<alphabet_size>::clear() {
  data *start = symbols;
  data *end = symbols + alphabet_size - 1;
...
template <unsigned long alphabet_size>
unsigned long
conditioning_class_kernel_2<alphabet_size>::get_memory_usage() const {
...
template <unsigned long alphabet_size>
typename conditioning_class_kernel_2<alphabet_size>::global_state_type &
conditioning_class_kernel_2<alphabet_size>::get_global_state() {
  return global_state;
}
...
template <unsigned long alphabet_size>
bool conditioning_class_kernel_2<alphabet_size>::increment_count(
...
template <unsigned long alphabet_size>
unsigned long conditioning_class_kernel_2<alphabet_size>::get_count(
...
template <unsigned long alphabet_size>
unsigned long conditioning_class_kernel_2<alphabet_size>::get_alphabet_size() {
...
template <unsigned long alphabet_size>
unsigned long conditioning_class_kernel_2<alphabet_size>::get_total() const {
  return total;
}
...
template <unsigned long alphabet_size>
unsigned long conditioning_class_kernel_2<alphabet_size>::get_range(
...
template <unsigned long alphabet_size>
void conditioning_class_kernel_2<alphabet_size>::get_symbol(
