...
template <> class member_function_pointer<void, void, void, void> {
  /*!
      INITIAL VALUE
          is_set() == false

      WHAT THIS OBJECT REPRESENTS
          This object represents a member function pointer.  It is useful
  because instances of this object can be created without needing to know the
  type of object whose member function we will be calling.
          ...
          You specify the parameters to your member function pointer by filling
  in the PARAM template parameters.  For example:

              To use a pointer to a function with no parameters you would say:
                  member_function_pointer<> my_pointer;
              To use a pointer to a function that takes a single int you would
  say: member_function_pointer<int> my_pointer; To use a pointer to a function
  that takes an int and then a reference to a string you would say:
...
public:
  ...
  member_function_pointer(const member_function_pointer &item);
  /*!
      ensures
          - *this == item
  !*/
  ...
  member_function_pointer &operator=(const member_function_pointer &item);
  /*!
      ensures
          - *this == item
  !*/

  bool operator==(const member_function_pointer &item) const;
  /*!
      ensures
  ...
  template <typename T> void set(T &object, void (T::*cb)());
  /*!
      requires
  ...
  template <typename T> void set(const T &object, void (T::*cb)() const);
  /*!
      requires
          - cb == a valid member function pointer for class T
      ensures
  ...
  void swap(member_function_pointer &item);
  /*!
      ensures
          - swaps *this and item
  !*/
...
public:
  ...
  template <typename T> void set(T &object, void (T::*cb)(PARAM1));

  template <typename T> void set(const T &object, void (T::*cb)(PARAM1) const);
...
public:
  ...
  template <typename T> void set(T &object, void (T::*cb)(PARAM1, PARAM2));

  template <typename T>
  void set(const T &object, void (T::*cb)(PARAM1, PARAM2) const);
...
public:
  ...
  template <typename T>
  void set(T &object, void (T::*cb)(PARAM1, PARAM2, PARAM3));

  template <typename T>
  void set(const T &object, void (T::*cb)(PARAM1, PARAM2, PARAM3) const);

  operator some_undefined_pointer_type() const;

  bool operator!() const;

  void operator()(PARAM1 param1, PARAM2 param2, PARAM2 param3) const;
...
public:
  ...
  template <typename T>
  void set(T &object, void (T::*cb)(PARAM1, PARAM2, PARAM3, PARAM4));
  ...
  void operator()(PARAM1 param1, PARAM2 param2, PARAM2 param3,
                  PARAM2 param4) const;
