...
template <typename EXP>
eigenvalue_decomposition<matrix_exp_type>::eigenvalue_decomposition(
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::matrix_type &
eigenvalue_decomposition<matrix_exp_type>::get_pseudo_v() const {
  return V;
}
...
template <typename matrix_exp_type>
long eigenvalue_decomposition<matrix_exp_type>::dim() const {
  return V.nr();
}
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<
    matrix_exp_type>::complex_column_vector_type
eigenvalue_decomposition<matrix_exp_type>::get_eigenvalues() const {
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::column_vector_type &
eigenvalue_decomposition<matrix_exp_type>::get_real_eigenvalues() const {
  return d;
}
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::column_vector_type &
eigenvalue_decomposition<matrix_exp_type>::get_imag_eigenvalues() const {
  return e;
}
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::complex_matrix_type
eigenvalue_decomposition<matrix_exp_type>::get_d() const {
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::complex_matrix_type
eigenvalue_decomposition<matrix_exp_type>::get_v() const {
  ...
  for (long i = 0; i < n; i++) {
    if (e(i) > 0) {
      ...
      set_colm(CV, i) =
          complex_matrix(colm(V, i), uniform_matrix<type>(n, 1, 0));
    }
  }
...
template <typename matrix_exp_type>
const typename eigenvalue_decomposition<matrix_exp_type>::matrix_type
eigenvalue_decomposition<matrix_exp_type>::get_pseudo_d() const {
  matrix_type D(n, n);
...
// Symmetric Householder reduction to tridiagonal form.
template <typename matrix_exp_type>
void eigenvalue_decomposition<matrix_exp_type>::tred2() {
  using std::abs;
  using std::sqrt;
...
template <typename matrix_exp_type>
void eigenvalue_decomposition<matrix_exp_type>::tql2() {
  using std::abs;
  using std::max;
  using std::min;
  using std::pow;
...
template <typename matrix_exp_type>
void eigenvalue_decomposition<matrix_exp_type>::orthes() {
  using std::abs;
  using std::sqrt;
...
template <typename matrix_exp_type>
void eigenvalue_decomposition<matrix_exp_type>::cdiv_(type xr, type xi, type yr,
                                                      type yi) {
  using std::abs;
  type r, d;
  if (abs(yr) > abs(yi)) {
...
template <typename matrix_exp_type>
void eigenvalue_decomposition<matrix_exp_type>::hqr2() {
  using std::abs;
  using std::max;
  using std::min;
  using std::pow;
