  ...
  /*!
      ensures
          ...
          - This version of the constructor is equivalent to using
            the default constructor and then calling
  set_seed(cast_to_string(seed_value)) throws
          - std::bad_alloc
  !*/
...
void serialize(const rand &item, std::ostream &out);
/*!
    provides serialization support
!*/

void deserialize(rand &item, std::istream &in);
/*!
