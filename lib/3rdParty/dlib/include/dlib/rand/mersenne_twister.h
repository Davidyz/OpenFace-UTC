...
template <class UIntType, int w, int n, int m, int r, UIntType a, int u, int s,
          UIntType b, int t, UIntType c, int l, UIntType val>
...
public:
  ...
  friend void serialize(const mersenne_twister &item, std::ostream &out) {
    dlib::serialize(item.x, out);
    dlib::serialize(item.i, out);
  }

  friend void deserialize(mersenne_twister &item, std::istream &in) {
...
template <class UIntType, int w, int n, int m, int r, UIntType a, int u, int s,
          UIntType b, int t, UIntType c, int l, UIntType val>
inline typename mersenne_twister<UIntType, w, n, m, r, a, u, s, b, t, c, l,
                                 val>::result_type
...
typedef random_helpers::mersenne_twister<uint32, 32, 351, 175, 19, 0xccab8ee7,
                                         11, 7, 0x31b6ab00, 15, 0xffe50000, 17,
                                         0xa37d3c92>
    mt11213b;

// validation by experiment from mt19937.c
typedef random_helpers::mersenne_twister<uint32, 32, 624, 397, 31, 0x9908b0df,
