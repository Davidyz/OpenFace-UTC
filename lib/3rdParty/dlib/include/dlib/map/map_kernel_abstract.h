...
public:
  ...
  bool is_in_domain(const domain &d) const;
  /*!
      ensures
...
template <typename domain, typename range, typename mem_manager,
          typename compare>
inline void swap(map<domain, range, mem_manager, compare> &a,
...
template <typename domain, typename range, typename mem_manager,
          typename compare>
void deserialize(map<domain, range, mem_manager, compare> &item,
                 std::istream &in);
/*!
