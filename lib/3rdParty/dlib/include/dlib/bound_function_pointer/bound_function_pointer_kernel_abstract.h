  ...
  /*!
      ...
      WHAT THIS OBJECT REPRESENTS
          ...
          specific objects.  For example:
              ...
              int a = 4;
              funct.set(test,a); // bind the variable a to the first argument of
  the test() function
...
public:
  ...
  operator some_undefined_pointer_type() const;
  /*!
      ensures
          - if (is_set()) then
  ...
  template <typename T, typename T1, typename A1, typename T2, typename A2>
  void set(const T &object, void (T::*funct)(T1, T2) const, A1 &arg1, A2 &arg2);
  /*!
      requires
          - funct == a valid bound function pointer for class T
      ensures
  ...
  /*!
      ...
      ensures
          - #is_set() == true
          - calls to this->operator() will call
  function_object(arg1,arg2,arg3,arg4)
  !*/
  ...
  /*!
      ...
      ensures
          - #is_set() == true
          - calls to this->operator() will call
  (object.*funct)(arg1,arg2,arg3,arg4)
  !*/
