...
class entropy_encoder {
  /*!
      ...
      NOTATION:
          ...
          to account for the current symbol.  ( The domain of P(i) is from 0 to
  N-1. )
  ...
  /*!
      ...
      throws
          - std::ios_base::failure
              if (stream_is_set() && there was a problem writing to
  get_stream()) then this exception will be thrown.  #*this will be unusable
