...
public:
  entropy_encoder_model_kernel_c(entropy_encoder &coder)
...
template <typename eem_base>
void entropy_encoder_model_kernel_c<eem_base>::encode(unsigned long symbol) {
