...
public:
  ...
  entropy_encoder_model_kernel_2(entropy_encoder &coder);
...
private:
  ...
  entropy_encoder_model_kernel_2(
      entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc, ccbig>
          &); // copy constructor
  entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc, ccbig> &
  operator=(entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc,
...
template <unsigned long alphabet_size, typename entropy_encoder, typename cc,
          typename ccbig>
entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc, ccbig>::
    entropy_encoder_model_kernel_2(entropy_encoder &coder_)
...
template <unsigned long alphabet_size, typename entropy_encoder, typename cc,
          typename ccbig>
entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc,
                               ccbig>::~entropy_encoder_model_kernel_2() {
...
template <unsigned long alphabet_size, typename entropy_encoder, typename cc,
          typename ccbig>
void entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc,
                                    ccbig>::clear() {
  previous_symbol = 0;
  order_0.clear();
  for (unsigned long i = 0; i < alphabet_size; ++i) {
...
template <unsigned long alphabet_size, typename entropy_encoder, typename cc,
          typename ccbig>
void entropy_encoder_model_kernel_2<alphabet_size, entropy_encoder, cc,
                                    ccbig>::encode(unsigned long symbol) {
