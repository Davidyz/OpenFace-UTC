...
public:
  ...
  entropy_encoder_model_kernel_4(entropy_encoder &coder);
...
private:
  ...
  entropy_encoder_model_kernel_4(
      entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder,
                                     total_nodes, order> &); // copy constructor
  entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder, total_nodes,
                                 order> &
  operator=(entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder,
                                           total_nodes, order>
                &); // assignment operator
};
...
entropy_encoder_model_kernel_4<
    ...
    order>::entropy_encoder_model_kernel_4(entropy_encoder &coder_)
    : next_node(1), coder(coder_), cur_order(0) {
...
template <unsigned long alphabet_size, typename entropy_encoder,
          unsigned long total_nodes, unsigned long order>
entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder, total_nodes,
                               order>::~entropy_encoder_model_kernel_4() {
  delete[] root;
}
...
template <unsigned long alphabet_size, typename entropy_encoder,
          unsigned long total_nodes, unsigned long order>
void entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder, total_nodes,
                                    order>::clear() {
  destroy_tree();
}
...
template <unsigned long alphabet_size, typename entropy_encoder,
          unsigned long total_nodes, unsigned long order>
bool entropy_encoder_model_kernel_4<alphabet_size, entropy_encoder, total_nodes,
