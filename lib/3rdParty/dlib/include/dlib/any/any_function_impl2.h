...
private:
  // You get a compiler error about this function being private if you try to
  // assign or copy between any_functions with different types.  You must only
  // copy between any_functions that represent functions with the same
  // signature.
...
class any_function<function_type, typename sig_traits<function_type>::type,
                   DLIB_ANY_FUNCTION_NUM_ARGS> {
