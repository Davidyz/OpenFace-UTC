...
template <typename function_type> class any_function {
  /*!
      REQUIREMENTS ON function_type
          This type should be a function signature.  Some examples are:
              void (int,int)  // a function returning nothing and taking two
  ints void ()         // a function returning nothing and taking no arguments
              char (double&)  // a function returning a char and taking a
  ...
  which matches the function signature defined by function_type.
  ...
  /*!
      ensures
          ...
          - else
              ...
              - Any previous object stored in this any_function object is
...
inline void swap(any_function<function_type> &a,
...
T &any_cast(any_function<function_type> &a) {
  return a.cast_to<T>();
}
/*!
    ensures
...
template <typename T, typename function_type>
const T &any_cast(const any_function<function_type> &a) {
  return a.cast_to<T>();
}
/*!
    ensures
