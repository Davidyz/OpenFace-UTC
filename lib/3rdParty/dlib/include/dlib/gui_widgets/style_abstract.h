...
public:
  ...
  /*!
      ensures
          - if (this style draws buttons differently when a mouse is over them)
  then
              - returns true
          - else
              - returns false
  ...
  /*!
      requires
          ...
          - is_depressed == true if the button is to be drawn in a depressed
  state ensures
...
class button_style_toolbar_icon1 : public button_style {
  ...
  button_style_toolbar_icon1(const image_type &img,
...
public:
  ...
  button_style_arrow(arrow_direction dir);
  /*!
      ensures
...
public:
  ...
  /*!
      ensures
          - if (this style draws a scroll_bar's slider differently when a mouse
  is over it or it is being dragged) then
              - returns true
          - else
              - returns false
  !*/
  ...
  button_style_type get_up_button_style() const;
  /*!
      ensures
  ...
  button_style_type get_down_button_style() const;
  /*!
      ensures
          - returns the type of button_style to use for a button on the
  ...
  button_style_type get_left_button_style() const;
  /*!
      ensures
          - returns the type of button_style to use for a button on the
  ...
  button_style_type get_right_button_style() const;
  /*!
      ensures
          - returns the type of button_style to use for a button on the
...
public:
  ...
  scroll_bar_style_type get_horizontal_scroll_bar_style() const;
  /*!
      ensures
  ...
  scroll_bar_style_type get_vertical_scroll_bar_style() const;
  /*!
      ensures
          - returns the style of scroll_bar to use for the
...
public:
  /*!
      This is the default style for scrollable_region and zoomable_region
  objects.
  !*/
};
...
public:
  ...
  scrollable_region_style_type get_scrollable_region_style() const;
  /*!
      ensures
  ...
  /*!
      requires
          ...
          - text_rect == the rectangle in which we should draw the given text
            of the drawable class.
          - display_rect == the rectangle returned by
  scrollable_region::display_rect()
          ...
          - if (highlight_start <= highlight_end) then
              - text[highlight_start] though text[highlight_end] should be
                highlighted
      ensures
          - draws the text_box on the canvas c at the location given by
  text_rect. (Note that the scroll bars and borders are drawn by the
  scrollable_region and therefore the style returned by
  get_scrollable_region_style() controls how those appear)
...
public:
  ...
  /*!
      requires
          ...
          - display_rect == the display_rect for the list_box.  This is the area
            in which list box items are drawn (see display_rect in the
  scrollable_region widget for more info)
          - enabled == true if the list box is enabled
      ensures
          - draws the background of a list box on the canvas c at the location
  given by display_rect.
  !*/
  ...
  /*!
      requires
          - the mutex drawable::m is locked
          - c == the canvas to draw on
          - rect == the rectangle that defines where on the screen this list box
  item is.
          - display_rect == the display_rect for the list_box.  This is the area
            in which list box items are drawn (see display_rect in the
  scrollable_region widget for more info)
      ...
      ensures
          - draws the list box item on the canvas c at the location given by
  rect.
  !*/
...
public:
  ...
  /*!
      requires
          - the mutex drawable::m is locked
      ensures
          - returns the number of pixels that separate the text in the
  text_field from the edge of the text_field widget itself.
  !*/
  ...
  /*!
      requires
          - the mutex drawable::m is locked
          - c == the canvas to draw on
          - rect, enabled, and mfont are the variables defined in the protected
  section of the drawable class.
