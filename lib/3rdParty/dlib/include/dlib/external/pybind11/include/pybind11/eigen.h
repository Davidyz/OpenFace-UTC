...
#pragma warning(disable : 4996) // warning C4996: std::unary_negate is
                                // deprecated in C++17
#endif
...
// don't want to force `move` when a Ref/Map rvalue is returned; we treat Ref<>
// sort of like a pointer (we care about the underlying data, not the outer
// shell).
