...
PNG_INTERNAL_FUNCTION(void, png_do_read_filler,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_read_swap_alpha,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif

#ifdef PNG_WRITE_SWAP_ALPHA_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_do_write_swap_alpha,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif

#ifdef PNG_READ_INVERT_ALPHA_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_do_read_invert_alpha,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif

#ifdef PNG_WRITE_INVERT_ALPHA_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_do_write_invert_alpha,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(int, png_do_rgb_to_gray,
                      (png_structrp png_ptr, png_row_infop row_info,
                       png_bytep row),
                      PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_do_gray_to_rgb,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif

#ifdef PNG_READ_PACK_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_do_unpack,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif

#ifdef PNG_READ_SHIFT_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_do_unshift,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_scale_16_to_8,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_do_quantize,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_correct_palette,
...
PNG_INTERNAL_FUNCTION(void, png_do_pack,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_shift,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_compose,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_gamma,
                      (png_row_infop row_info, png_bytep row,
                       png_structrp png_ptr),
                      PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_do_encode_alpha,
                      (png_row_infop row_info, png_bytep row,
                       png_structrp png_ptr),
                      PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_do_expand_palette,
                      (png_row_infop row_info, png_bytep row,
                       png_const_colorp palette, png_const_bytep trans,
                       int num_trans),
                      PNG_EMPTY);
PNG_INTERNAL_FUNCTION(void, png_do_expand,
                      (png_row_infop row_info, png_bytep row,
...
PNG_INTERNAL_FUNCTION(void, png_do_expand_16,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_push_check_crc, (png_structrp png_ptr),
                      PNG_EMPTY);
PNG_INTERNAL_FUNCTION(void, png_push_crc_skip,
                      (png_structrp png_ptr, png_uint_32 length), PNG_EMPTY);
...
PNG_INTERNAL_FUNCTION(void, png_do_read_intrapixel,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
PNG_INTERNAL_FUNCTION(void, png_do_write_intrapixel,
                      (png_row_infop row_info, png_bytep row), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_ascii_from_fp,
                      (png_const_structrp png_ptr, png_charp ascii,
...
PNG_INTERNAL_FUNCTION(int, png_check_fp_number,
                      (png_const_charp string, png_size_t size, int *statep,
...
PNG_INTERNAL_FUNCTION(int, png_check_fp_string,
                      (png_const_charp string, png_size_t size), PNG_EMPTY);
#endif /* pCAL || sCAL */
 ...
 */
PNG_INTERNAL_FUNCTION(void, png_safe_error,
                      (png_structp png_ptr, png_const_charp error_message),
                      PNG_NORETURN);

#ifdef PNG_WARNINGS_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_safe_warning,
