 ...
 * Glenn See also "Contributing Authors", below.
 *
...
#define PNG_HEADER_VERSION_STRING " libpng version 1.6.7 - November 14, 2013\n"
 ...
 */
PNG_EXPORTA(99, void, png_data_freer,
...
#define PNG_get_int_32(buf)                                                    \
  ((png_int_32)((*(buf)&0x80)                                                  \
                    ? -((png_int_32)((png_get_uint_32(buf) ^ 0xffffffffL) +    \
                                     1))                                       \
