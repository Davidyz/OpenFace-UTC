...
struct jpeg_c_coef_controller {
  JMETHOD(void, start_pass, (j_compress_ptr cinfo, J_BUF_MODE pass_mode));
  JMETHOD(int, compress_data, (j_compress_ptr cinfo, JSAMPIMAGE input_buf));
};
...
EXTERN(void)
jinit_c_master_control JPP((j_compress_ptr cinfo, int transcode_only));
EXTERN(void)
jinit_c_main_controller JPP((j_compress_ptr cinfo, int need_full_buffer));
EXTERN(void)
jinit_c_prep_controller JPP((j_compress_ptr cinfo, int need_full_buffer));
EXTERN(void)
jinit_c_coef_controller JPP((j_compress_ptr cinfo, int need_full_buffer));
...
EXTERN(void)
jinit_d_main_controller JPP((j_decompress_ptr cinfo, int need_full_buffer));
EXTERN(void)
jinit_d_coef_controller JPP((j_decompress_ptr cinfo, int need_full_buffer));
EXTERN(void)
jinit_d_post_controller JPP((j_decompress_ptr cinfo, int need_full_buffer));
