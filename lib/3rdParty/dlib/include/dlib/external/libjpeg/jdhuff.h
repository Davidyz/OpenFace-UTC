...
jpeg_make_d_derived_tbl
    JPP((j_decompress_ptr cinfo, int isDC, int tblno, d_derived_tbl **pdtbl));
...
jpeg_fill_bit_buffer JPP((bitread_working_state * state,
                          bit_buf_type get_buffer, int bits_left, int nbits));
...
EXTERN(int)
jpeg_huff_decode JPP((bitread_working_state * state, bit_buf_type get_buffer,
