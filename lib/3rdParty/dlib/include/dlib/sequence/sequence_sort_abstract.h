...
template <typename seq_base> class sequence_sort : public seq_base {
  ...
  /*!
      ...
      WHAT THIS EXTENSION DOES FOR sequence
          this gives a sequence the ability to sort its contents by calling
  sort()
  !*/
...
inline void swap(sequence_sort<seq_base> &a, sequence_sort<seq_base> &b) {
  a.swap(b);
}
/*!
