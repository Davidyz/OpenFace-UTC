...
class linker {
  ...
  /*!
      ...
      CONVENTION
          ...
          service_connection_running          == true when service_connection()
  is running or is about to run else false service_connection_running_mutex == a
  mutex for service_connection_running service_connection_running_signaler == a
  signaler associated with service_connection_running_mutex
          ...
          service_connection_error        == service_connection uses this bool
                                             ...
                                             an error or not
          service_connection_error_mutex  == a mutex for
...
public:
  ...
  linker(connection &a, connection &b);
  ...
  void link(connection &a, connection &b);

private:
  static void service_connection(void *param);
  /*!
      requires
