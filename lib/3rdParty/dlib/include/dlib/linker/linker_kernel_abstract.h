...
class linker {
  ...
  /*!
      ...
      WHAT THIS OBJECT REPRESENTS
          ...
          them talk to each other.  i.e. any incoming data from one connection
  is passed unaltered to the other and vice versa.
          ...
          (i.e. the FIN packet is effectively also forwarded by the linker
  object)
