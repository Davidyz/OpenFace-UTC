    ...
    do {
      ...
      if (FindNextFileA(ffind, &data) == 0) {
        ...
        if (GetLastError() == ERROR_NO_MORE_FILES) {
          ...
          // there was an error
          throw listing_error("Unable to list the contents of " +
                              state.full_name);
        }
      }
