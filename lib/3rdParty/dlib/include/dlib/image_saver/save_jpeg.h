...
void save_jpeg(const array2d<rgb_pixel> &img, const std::string &filename,
               int quality = 75);

// ----------------------------------------------------------------------------------------

void save_jpeg(const array2d<unsigned char> &img, const std::string &filename,
               int quality = 75);
...
save_jpeg(const image_type &img, const std::string &filename,
          int quality = 75) {
...
void save_jpeg(const matrix_exp<EXP> &img, const std::string &file_name,
               int quality = 75) {
