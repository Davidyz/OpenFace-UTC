...
void save_bmp(const image_type &image, std::ostream &out);
/*!
    requires
        - image_type == an image object that implements the interface defined in
          dlib/image_processing/generic_image.h or any kind of matrix
expression. ensures
        - writes the image to the out stream in the Microsoft Windows BMP
format.
...
/*!
    requires
        - image_type == an image object that implements the interface defined in
          dlib/image_processing/generic_image.h or any kind of matrix
expression. ensures
        - opens the file indicated by file_name with an output file stream named
fout and performs: save_bmp(image,fout);
!*/
...
template <typename image_type>
void save_dng(const image_type &image, std::ostream &out);
/*!
    requires
        - image_type == an image object that implements the interface defined in
          dlib/image_processing/generic_image.h or any kind of matrix
...
the DNG format can natively store only the following pixel types: rgb_pixel,
...
expression. ensures
        - opens the file indicated by file_name with an output file stream named
fout and performs: save_dng(image,fout);
!*/
