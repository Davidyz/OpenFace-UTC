...
template <typename tokenizer> class cpp_tokenizer_kernel_c : public tokenizer {
...
inline void swap(cpp_tokenizer_kernel_c<tokenizer> &a,
...
template <typename tokenizer>
std::istream &cpp_tokenizer_kernel_c<tokenizer>::get_stream() const {
...
template <typename tokenizer>
const std::string &cpp_tokenizer_kernel_c<tokenizer>::peek_token() const {
  // make sure requires clause is not broken
...
template <typename tokenizer>
int cpp_tokenizer_kernel_c<tokenizer>::peek_type() const {
  // make sure requires clause is not broken
  DLIB_CASSERT(this->stream_is_set() == true,
...
template <typename tokenizer>
void cpp_tokenizer_kernel_c<tokenizer>::get_token(int &type,
                                                  std::string &token) {
  // make sure requires clause is not broken
  DLIB_CASSERT(this->stream_is_set() == true,
