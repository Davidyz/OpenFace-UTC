...
template <typename bit_stream_base // implements
                                   // bit_stream/bit_stream_kernel_abstract.h
          >
...
template <typename bit_stream_base>
inline void swap(bit_stream_kernel_c<bit_stream_base> &a,
...
template <typename bit_stream_base>
void bit_stream_kernel_c<bit_stream_base>::set_input_stream(std::istream &is) {
  // make sure requires clause is not broken
  DLIB_CASSERT((this->is_in_write_mode() == false) &&
...
template <typename bit_stream_base>
void bit_stream_kernel_c<bit_stream_base>::set_output_stream(std::ostream &os) {
...
template <typename bit_stream_base>
void bit_stream_kernel_c<bit_stream_base>::close() {

  // make sure requires clause is not broken
  DLIB_CASSERT((this->is_in_write_mode() == true) ||
...
template <typename bit_stream_base>
void bit_stream_kernel_c<bit_stream_base>::write(int bit) {
  // make sure requires clause is not broken
  DLIB_CASSERT((this->is_in_write_mode() == true) && (bit == 0 || bit == 1),
               "\tvoid bit_stream::write"
                   << "\n\tthe bit stream bust be in write mode and bit must "
                      "be either 1 or 0"
...
template <typename bit_stream_base>
bool bit_stream_kernel_c<bit_stream_base>::read(int &bit) {
