...
private:
  ...
  connection(SOCKET_container sock, unsigned short foreign_port,
...
private:
  ...
  /*!
      requires
          sock is a socket handle and sock is listening on the port and ip(may
  be "") indicated in the above parameters ensures *this is initialized
  correctly with the above parameters
  !*/
