...
template <typename map_base> class static_map_kernel_c : public map_base {
...
inline void swap(static_map_kernel_c<map_base> &a,
...
template <typename map_base>
const map_pair<typename map_base::domain_type, typename map_base::range_type> &
static_map_kernel_c<map_base>::element() const {
...
template <typename map_base>
map_pair<typename map_base::domain_type, typename map_base::range_type> &
static_map_kernel_c<map_base>::element() {
  // make sure requires clause is not broken
  DLIB_CASSERT(
      this->current_element_valid() == true,
