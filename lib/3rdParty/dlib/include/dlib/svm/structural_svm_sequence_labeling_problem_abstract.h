...
class structural_svm_sequence_labeling_problem
  ...
  structural SVM problem.  The general approach is discussed in the paper:
...
public:
  ...
  structural_svm_sequence_labeling_problem(
      ...
      const feature_extractor &fe, unsigned long num_threads = 2);
  /*!
      requires
  ...
  learn a parameter vector, w, such that a sequence_labeler declared as:
