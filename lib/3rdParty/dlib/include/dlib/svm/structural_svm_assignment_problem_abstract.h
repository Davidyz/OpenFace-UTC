...
class structural_svm_assignment_problem
  ...
  dlib/svm/assignment_function_abstract.h.
      ...
      WHAT THIS OBJECT REPRESENTS
          ...
          assignment_function object.  It learns the parameters by formulating
...
public:
  ...
  structural_svm_assignment_problem(const std::vector<sample_type> &samples,
  ...
  learn a parameter vector and bias, w and b, such that an assignment_function
  declared as: assignment_function<feature_extractor>
  assigner(w,b,fe,force_assignment) results in an assigner object which attempts
  to compute the following mapping: labels[i] == labeler(samples[i])
