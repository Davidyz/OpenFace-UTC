...
template <typename K> class svm_c_trainer {
  /*!
      ...
      WHAT THIS OBJECT REPRESENTS
          ...
          solving binary classification problems.  It is implemented using the
  SMO algorithm.

          The implementation of the C-SVM training algorithm used by this object
...
public:
  ...
  svm_c_trainer(const kernel_type &kernel, const scalar_type &C);
  /*!
      requires
          - 0 < C
      ensures
  ...
  and labels in y.  Training is done when the error is less than get_epsilon().
