...
public:
  ...
  /*!
      ...
      throws
          - std::bad_alloc
              ...
              characters may have been read from in.  rhs is still usable
  though, its value is just unknown.
  !*/
  ...
  friend const bigint operator+(uint16 lhs, const bigint &rhs);
  /*!
      requires
          - lhs <= 65535
      ensures
  ...
  friend const bigint operator+(const bigint &lhs, uint16 rhs);
  /*!
      requires
          - rhs <= 65535
      ensures
  ...
  friend bool operator<(uint16 lhs, const bigint &rhs);
  /*!
      requires
          - lhs <= 65535
      ensures
  ...
  friend bool operator<(const bigint &lhs, uint16 rhs);
  /*!
      requires
          - rhs <= 65535
      ensures
...
inline void swap(bigint &a, bigint &b) { a.swap(b); }
/*!
    provides a global swap function
!*/

void serialize(const bigint &item, std::istream &in);
/*!
    provides serialization support
!*/

void deserialize(bigint &item, std::istream &in);
/*!
