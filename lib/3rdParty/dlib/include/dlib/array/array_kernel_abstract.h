...
public:
  ...
  /*!
      ensures
          - returns an iterator that points to the first element in this array
  or end() if the array is empty.
  !*/
...
template <typename T> inline void swap(array<T> &a, array<T> &b) { a.swap(b); }
/*!
    provides a global swap function
!*/

template <typename T> void serialize(const array<T> &item, std::ostream &out);
/*!
    provides serialization support
!*/

template <typename T> void deserialize(array<T> &item, std::istream &in);
/*!
