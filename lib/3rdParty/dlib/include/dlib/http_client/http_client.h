...
public:
  ...
  void set_timeout(unsigned int milliseconds = DEFAULT_TIMEOUT) {
...
private:
  bool grab_url(const std::string &url, const std::string &method = "GET",
                const std::string &post_body = "");
  std::string build_post(std::string &content_type,
                         const string_to_stringmap &postvars,
                         const string_to_stringmap &filenames) const;
  ...
  bool parse_url(const std::string &url, std::string &scheme, std::string &user,
                 std::string &pass, std::string &host, short &port,
