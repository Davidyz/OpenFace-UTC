...
public:
  ...
  entropy_decoder_model_kernel_4(entropy_decoder &coder);
...
private:
  ...
  entropy_decoder_model_kernel_4(
      entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder,
                                     total_nodes, order> &); // copy constructor
  entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder, total_nodes,
                                 order> &
  operator=(entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder,
                                           total_nodes, order>
                &); // assignment operator
};
...
entropy_decoder_model_kernel_4<
    ...
    order>::entropy_decoder_model_kernel_4(entropy_decoder &coder_)
...
template <unsigned long alphabet_size, typename entropy_decoder,
          unsigned long total_nodes, unsigned long order>
entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder, total_nodes,
                               order>::~entropy_decoder_model_kernel_4() {
  delete[] root;
}
...
template <unsigned long alphabet_size, typename entropy_decoder,
          unsigned long total_nodes, unsigned long order>
void entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder, total_nodes,
                                    order>::clear() {
  destroy_tree();
}
...
template <unsigned long alphabet_size, typename entropy_decoder,
          unsigned long total_nodes, unsigned long order>
bool entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder, total_nodes,
...
template <unsigned long alphabet_size, typename entropy_decoder,
          unsigned long total_nodes, unsigned long order>
edmk4::node *entropy_decoder_model_kernel_4<alphabet_size, entropy_decoder,
                                            total_nodes, order>::pop() {
  --stack_size;
