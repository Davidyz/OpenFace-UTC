...
class thread_function : private threaded_object {
  ...
  public:
    super_funct_4(F funct, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        : f(funct), a1(arg1), a2(arg2), a3(arg3), a4(arg4) {}
  ...
  public:
    super_funct_3(F funct, T1 arg1, T2 arg2, T3 arg3)
        : f(funct), a1(arg1), a2(arg2), a3(arg3) {}
  ...
  public:
    super_funct_2(F funct, T1 arg1, T2 arg2) : f(funct), a1(arg1), a2(arg2) {}
  ...
  template <typename F, typename T> class super_funct_1 : public base_funct {
  public:
  ...
  template <typename F> class super_funct_0 : public base_funct {
  public:
...
public:
  template <typename F> thread_function(F funct) {
    f.reset(new super_funct_0<F>(funct));
    start();
  }

  template <typename F, typename T> thread_function(F funct, T arg) {
    f.reset(new super_funct_1<F, T>(funct, arg));
    start();
  }

  template <typename F, typename T1, typename T2>
  thread_function(F funct, T1 arg1, T2 arg2) {
    f.reset(new super_funct_2<F, T1, T2>(funct, arg1, arg2));
    start();
  }

  template <typename F, typename T1, typename T2, typename T3>
  thread_function(F funct, T1 arg1, T2 arg2, T3 arg3) {
    f.reset(new super_funct_3<F, T1, T2, T3>(funct, arg1, arg2, arg3));
    start();
  }

  template <typename F, typename T1, typename T2, typename T3, typename T4>
  thread_function(F funct, T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
    f.reset(
        new super_funct_4<F, T1, T2, T3, T4>(funct, arg1, arg2, arg3, arg4));
    start();
  }

  ~thread_function() { threaded_object::wait(); }

  bool is_alive() const { return threaded_object::is_alive(); }

  void wait() const { threaded_object::wait(); }
