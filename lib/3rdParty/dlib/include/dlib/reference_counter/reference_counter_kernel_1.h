...
template <typename T, typename copy = copy_functor<T>>
...
public:
  ...
  inline reference_counter_kernel_1(const reference_counter_kernel_1 &item);
  ...
  operator=(const reference_counter_kernel_1 &rhs);

  inline void swap(reference_counter_kernel_1 &item);
...
inline void swap(reference_counter_kernel_1<T, copy> &a,
...
template <typename T, typename copy>
reference_counter_kernel_1<T, copy>::reference_counter_kernel_1() {
  data = new T;
  try {
    count = new unsigned long;
  } catch (...) {
    delete data;
    throw;
  }
...
template <typename T, typename copy>
void reference_counter_kernel_1<T, copy>::clear() {
...
template <typename T, typename copy>
T &reference_counter_kernel_1<T, copy>::modify() {
...
template <typename T, typename copy>
const T &reference_counter_kernel_1<T, copy>::access() const {
  return *data;
}
...
reference_counter_kernel_1<T, copy>::operator=(
...
template <typename T, typename copy>
void reference_counter_kernel_1<T, copy>::swap(
