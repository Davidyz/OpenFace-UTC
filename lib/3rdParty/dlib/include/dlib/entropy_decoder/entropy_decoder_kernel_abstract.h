...
class entropy_decoder {
  /*!
      ...
      NOTATION:
          ...
          symbol of an N symbol alphabet. Note that P(i) refers to the
  probability of seeing the ith symbol WITHOUT considering the symbol currently
  given by get_target(TOTAL).  ( The domain of P(i) is from 0 to N-1. )
          ...
          for each i: #P(i) == #COUNT/#TOTAL where #COUNT and #TOTAL are
  integers and #TOTAL is the same number for all #P(i) but #COUNT may vary.
  !*/
