...
void get_histogram(const in_image_type &in_img_,
...
void get_histogram(const in_image_type &in_img_,
  ...
  typedef typename pixel_traits<pixel_type>::basic_pixel_type
...
void equalize_histogram(const in_image_type &in_img_,
  ...
  typedef typename pixel_traits<in_pixel_type>::basic_pixel_type
      in_image_basic_pixel_type;
  COMPILE_TIME_ASSERT(sizeof(in_image_basic_pixel_type) <= 2);
