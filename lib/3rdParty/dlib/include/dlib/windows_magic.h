...
// because otherwise we don't need it since everything is isolated in the
// sockets cpp file and this declaration for _WINSOCKAPI_ appears there also.
#ifndef _WINSOCKAPI_
#define _WINSOCKAPI_ /* Prevent inclusion of winsock.h in windows.h */
#endif
#endif

// This is something stupid you have to do to make visual studio include the
// right stuff.  I don't really know what the deal is with this.
