...
// Collection of linear SVR regressors for AU prediction that uses per person
// face nomalisation with the help of a running median
...
public:
  ...
  std::vector<double> GetCutoffs() const { return cutoffs; }
