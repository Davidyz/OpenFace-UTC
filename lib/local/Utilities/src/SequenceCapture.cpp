...
bool SequenceCapture::OpenVideoFile(std::string video_file, float fx, float fy,
                                    float cx, float cy) {
...
bool SequenceCapture::OpenImageSequence(std::string directory, float fx,
  ...
  copy(fs::directory_iterator(image_directory), fs::directory_iterator(),
  ...
  for (std::vector<fs::path>::const_iterator file_iterator(
           file_in_directory.begin());
       file_iterator != file_in_directory.end(); ++file_iterator) {
...
void SequenceCapture::SetCameraIntrinsics(float fx, float fy, float cx,
                                          float cy) {
