...
public:
  ...
  bool Open(std::string output_file_name, bool is_sequence,
            bool output_2D_landmarks, bool output_3D_landmarks,
            bool output_model_params, bool output_pose, bool output_AUs,
            bool output_gaze, int num_face_landmarks, int num_model_modes,
  ...
  void
  WriteLine(int face_id, int frame_num, double time_stamp,
            ...
            const cv::Point3f &gazeDirection1, const cv::Vec2f &gaze_angle,
