...
// A copy constructor
SVR_patch_expert::SVR_patch_expert(const SVR_patch_expert &other)
...
//===========================================================================
void SVR_patch_expert::Response(const cv::Mat_<float> &area_of_interest,
  ...
  matchTemplate_m(normalised_area_of_interest, empty_matrix_0, empty_matrix_1,
                  empty_matrix_2, weights, weights_dfts, svr_response,
                  cv::TM_CCOEFF_NORMED);
...
void SVR_patch_expert::ResponseDepth(const cv::Mat_<float> &area_of_interest,
                                     cv::Mat_<float> &response) {
...
// Copy constructor
Multi_SVR_patch_expert::Multi_SVR_patch_expert(
    const Multi_SVR_patch_expert &other)
    : svr_patch_experts(other.svr_patch_experts) {
...
//===========================================================================
void Multi_SVR_patch_expert::Response(const cv::Mat_<float> &area_of_interest,
                                      cv::Mat_<float> &response) {
  ...
  // For the purposes of the experiment only use the response of normal
  // intensity, for fair comparison
...
void Multi_SVR_patch_expert::ResponseDepth(
