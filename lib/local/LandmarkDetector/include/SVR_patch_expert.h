...
public:
  ...
  // Discrete Fourier Transform of SVR weights, precalculated for speed (at
  ...
  void ResponseDepth(const cv::Mat_<float> &area_of_interest,
                     cv::Mat_<float> &response);
};
//===========================================================================
/**
    A Multi-patch Expert that can include different patch types. Raw pixel
   values or image gradients
*/
...
public:
  ...
  // Vector of all of the patch experts (different modalities) for this
  // particular Multi patch expert
