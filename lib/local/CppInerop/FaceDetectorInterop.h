...
public:
  ...
  void DetectFacesHOG(List<System::Windows::Rect> ^ o_regions,
    ...
    ::LandmarkDetector::DetectFacesHOG(regions_ocv, intensity->Mat,
                                       *face_detector_hog, confidences_std);

    o_regions->Clear();
    o_confidences->Clear();

    for (size_t i = 0; i < regions_ocv.size(); ++i) {
      o_regions->Add(System::Windows::Rect(regions_ocv[i].x, regions_ocv[i].y,
                                           regions_ocv[i].width,
  ...
  void DetectFacesHaar(List<System::Windows::Rect> ^ o_regions,
    ...
    ::LandmarkDetector::DetectFaces(regions_ocv, intensity->Mat,
                                    *face_detector_haar);
  ...
  void DetectFacesMTCNN(List<System::Windows::Rect> ^ o_regions,
    ...
    ::LandmarkDetector::DetectFacesMTCNN(regions_ocv, rgb_image->Mat,
                                         *face_detector_mtcnn, confidences_std);
