...
//
///////////////////////////////////////////////////////////////////////////////
// FaceTrackingVid.cpp : Defines the entry point for the console application for
...
int main(int argc, char **argv) {
      ...
      true) // this is not a for loop as we might also be reading from a webcam
  {
    ...
    while (!rgb_image.empty()) // this is not a for loop as we might also be
                               // reading from a webcam
    {
      ...
      // detect key presses (due to pecularities of OpenCV, you can get it when
      // displaying images)
